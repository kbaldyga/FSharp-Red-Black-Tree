...
namespace RBTree.Console
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Execute("fset  contains", () => { randoms.ForEach(r => fset.Contains(r)); return tree; });
            Execute("immset  contains", () => { randoms.ForEach(r => immSet.Contains(r)); return tree; });
            ...
            Execute("fset  remove", () => { randoms.ForEach(r => fset = fset.Remove(r)); return tree; });
            Execute("immset  remove", () => { randoms.ForEach(r => immSet = immSet.Remove(r)); return tree; });
